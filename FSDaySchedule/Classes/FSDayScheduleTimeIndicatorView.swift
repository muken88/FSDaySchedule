//
//  FSDayScheduleTimeIndicatorView.swift
//  FSDaySchedule
//
...
///显示当前时间和红点红线的View
internal class FSDayScheduleTimeIndicatorView: UIView {
...
// MARK: - public func
extension FSDayScheduleTimeIndicatorView {
    ...
    public func updateTime() {
        ...
        if self.superview != nil {
            let y = hourValue * FSDayScheduleView.OneHourHeight
